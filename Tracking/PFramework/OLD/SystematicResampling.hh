...
#include "ParticleC.hh"
#include "BaseResamplingModelC.hh"
using namespace RavlN;


class SystematicResampling : public BaseResamplingModelC 
{
public:
	...
	virtual void operator=(const SystematicResampling &mmdl) 
	{
