/*
  This example program is intended as a very rough guide to using the
  OmniPerception face detectors.  There are doubtless parameters that could be
  set.  

  I was advised that the models are tuned for moderate-sized images; hence the
  subsampling that goes on.

  Contact OmniPerception for more information concerning their use.
