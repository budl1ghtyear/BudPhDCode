...
class JMeasurementModel : public BaseMeasurementModelC
{
public:
	JMeasurementModel(){}
	~JMeasurementModel(){}
	JMeasurementModel(const MeanCovarianceC &lp, const MeanCovarianceC &sk, const ImageC<RealRGBValueC> &img, const IntT &wd);
	virtual RealT Measure(ParticleC &pt);
	virtual void operator=(const JMeasurementModel &oth)
	{
		lip = oth.GetLipMC();
		skin = oth.GetSkinMC();
