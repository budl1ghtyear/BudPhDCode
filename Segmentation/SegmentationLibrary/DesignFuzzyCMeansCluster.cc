...
//namespace RavlN {
  ...
  MyDesignFuzzyCMeansClusterBodyC::MyDesignFuzzyCMeansClusterBodyC (UIntT numClasses, const DistanceC &distance, RealT m)
    : sizeY(numClasses),
      _distance(distance),
      _m(m),
	  _initialised(false)
  ...
  MyDesignFuzzyCMeansClusterBodyC::MyDesignFuzzyCMeansClusterBodyC (istream &in)
    : DesignClusterBodyC(in)
  { in >> _centres >> _distance >> _m; }

  MyDesignFuzzyCMeansClusterBodyC::MyDesignFuzzyCMeansClusterBodyC (const MyDesignFuzzyCMeansClusterBodyC &oth)
    : DesignClusterBodyC(oth),
      _centres(oth._centres.Copy()),
      _distance(oth._distance),
      _m(oth._m),
	  _initialised(oth._initialised)
  {}
  
  RCBodyVC & MyDesignFuzzyCMeansClusterBodyC::Copy () const
  { return *(new MyDesignFuzzyCMeansClusterBodyC (*this)); }
  
  void MyDesignFuzzyCMeansClusterBodyC::Initialise (UIntT numClasses, const SampleC<VectorC> &trainX)
  {
    {
  ...
  FunctionC MyDesignFuzzyCMeansClusterBodyC::Apply (const SampleC<VectorC> &trainX)
  {
  ...
  bool MyDesignFuzzyCMeansClusterBodyC::Save (ostream &out) const
  {
